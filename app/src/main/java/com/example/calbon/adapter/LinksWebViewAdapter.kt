...
class LinksAdapter : RecyclerView.Adapter<LinksAdapter.VH>() {
    ...
    inner class VH(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: LinkItem) {
            ...
            // Glide com placeholder e tratamento de erro
            Glide.with(imagem.context)
                .load(item.img)
                .placeholder(R.drawable.ic_web_placeholder) // ícone local de placeholder
                .error(R.drawable.ic_web_error)       // ícone caso URL falhe
                .into(imagem)
